  ...
  obterParaGrid() : Observable<JogoGrid[]>{
    let jogos = [
      ...
      },
      {
        id: 11,
        nome: "CS-2",
        descricao: "Um jogo de tiro onde o mais brabo vence.",
        preco: 0,
        desenvolvedora: "Valve",
        tags: ["FPS", "Multiplayer Online"],
        categoria: "Tiro em Primeira Pessoas",
        foto: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCbxlZiMB6tkxLTfDqnvuku4m0-f-7kkPQgA&s"
      },
      {
        id: 12,
        nome: "EAFC 25",
        ...
        tags: ["Esporte"],
        categoria: "Esporte",
        foto: "https://uploads.metroimg.com/wp-content/uploads/2024/07/18110354/EA-Sports-FC-25.jpg"
      }
    ];
    return of(jogos);
  }
